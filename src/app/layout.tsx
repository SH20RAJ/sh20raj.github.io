...
export const metadata: Metadata = {
  ...
  title: {
    default: "Shaswat Raj — Next.js & AI Product Developer for Startups",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Shaswat Raj — Next.js & AI Product Developer for Startups",
      },
    ],
  },
  robots: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      jobTitle: "Next.js & AI Product Developer",
      description:
        "Remote Next.js, TypeScript, AI, SaaS MVP, landing page, dashboard, and automation developer helping founders and agencies ship fast.",
