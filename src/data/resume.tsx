  ...
  work: [
    {
      ...
      description:
        "Lead development of complex full-stack applications using Next.js, React, and Node.js. Architect scalable solutions handling 10K+ concurrent users. Implement AI-powered features using OpenAI and custom ML models. Mentor junior developers and conduct code reviews.",
    },
    {
      ...
      description:
        "Developed responsive web applications using React, Vue.js, and Angular. Built robust backend APIs with Node.js, Express, and Laravel. Implemented real-time features using WebSockets and Socket.io. Optimized application performance resulting in 40% faster load times.",
    },
    {
      ...
      description:
        "Created pixel-perfect, responsive user interfaces using React and TypeScript. Collaborated with UX/UI designers to implement modern design systems. Integrated third-party APIs and payment gateways. Maintained cross-browser compatibility across all major browsers.",
    },
    {
